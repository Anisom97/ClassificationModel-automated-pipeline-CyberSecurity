...
def KNN_metric(y_train,y_pred_train_knn,x_valid,y_valid,knn_model):
    train_avg_metric_knn,valid_avg_metric_knn,y_pred_valid_knn,acc_train_knn,acc_valid_knn=model_metric_calculation(y_train,
                                                                                                                   y_pred_train_knn,
                                                                                                                   x_valid,
                                                                                                                   y_valid,
                                                                                                                   knn_model,
                                                                                                                   'KNN')
    return train_avg_metric_knn,valid_avg_metric_knn,y_pred_valid_knn,acc_train_knn,acc_valid_knn


# In[ ]:


def KNN_store(y_pred_valid_knn):
    pred_valid_knn=pd.DataFrame(y_pred_valid_knn,columns=['pred_valid_knn'])
    return pred_valid_knn
